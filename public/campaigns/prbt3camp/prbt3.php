  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="clearfix colelem" id="pu746"><!-- group -->
    <div class="clip_frame grpelem" id="u746"><!-- image -->
     <img class="block" id="u746_img" src="image/janith-iddhamalgoda2.jpg?crc=256007460" alt="" width="348" height="348"/>
    </div>
    ...
    <div class="clearfix grpelem" id="u795"><!-- column -->
     <div class="clearfix colelem" id="u753-4"><!-- content -->
      <p>Janith Iddhamalgoda</p>
     </div>
     <div class="clearfix colelem" id="u704-4"><!-- content -->
      <p>Duppathda Mage Adare</p>
     </div>
    ...
    <div class="clearfix grpelem" id="u826"><!-- column -->
     <div class="position_content" id="u826_position_content">
      <div class="clearfix colelem" id="u818"><!-- group -->
       <a class="nonblock nontext clearfix grpelem" id="u819-4" onclick="clickEvent('true');" href="http://www.agora.lk/rbtprovisioning/?toneID=534352&amp;title=Duppathda_Mage_Adare&click_id=<?php echo $clickid; ?>" ><!-- content --><p id="u819-2">download</p></a>
      </div>
      <a class="nonblock nontext clip_frame colelem" id="u820" onclick="clickEvent('true');" href="http://www.agora.lk/rbtprovisioning/?toneID=534352&amp;title=Duppathda_Mage_Adare&click_id=<?php echo $clickid; ?>"><!-- image --><img class="block" id="u820_img" src="image/download.png?crc=73124302" alt="" width="36" height="36"/></a>
     </div>
    </div>
    <div class="clearfix grpelem" id="u827"><!-- column -->
     <div class="clearfix colelem" id="u805"><!-- group -->
      <a class="nonblock nontext clearfix grpelem" id="u803-4" href="http://ringintones.dialog.lk:8080/colorring/al/601/534/0/0000/0000/352.wav"><!-- content --><p id="u803-2">preview</p></a>
     </div>
     <a class="nonblock nontext clip_frame colelem" id="u806" href="http://ringintones.dialog.lk:8080/colorring/al/601/534/0/0000/0000/352.wav"><!-- image --><img class="block" id="u806_img" src="image/preview.png?crc=3762581190" alt="" width="36" height="36"/></a>
    </div>
   </div>
...
Muse.Utils.transformMarkupToFixBrowserProblems();/* body */
  ...
  <script src="scripts/ajax_request_prbt3.js" type="text/javascript"></script>`
  <!-- RequireJS script -->
