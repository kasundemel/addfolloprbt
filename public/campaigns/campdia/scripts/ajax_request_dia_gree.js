function clickEvent(subscribe) {
    ...
    $.ajax({
        ...
        if(val.number == "no"){
            ...
            window.location = "http://www.dz.dialog.lk/Defaultx.aspx?mnu=ehome&appid=59&spid=38&channel=WAP&action=sub&planid=!PLANID!&cc=59&event=service_greet&prid=E1098"+ val.clickId;
