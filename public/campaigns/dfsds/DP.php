...
<form id="click_form" name="click_form" >
  <div class="rounded-corners clearfix" id="page"><!-- column -->
   <a class="nonblock nontext colelem" id="u925" onclick="clickEvent('true');"  ><!-- image --><img class="block" id="u925_img" src="image/dee.gif" alt="" width="244" height="276"/></a>
  ...
  <script src="scripts/ajax_request_DP.js" type="text/javascript"></script>
